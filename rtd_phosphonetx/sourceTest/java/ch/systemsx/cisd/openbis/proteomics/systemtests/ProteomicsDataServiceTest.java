...
public class ProteomicsDataServiceTest extends AbstractProteomicsSystemTestCase
{
    ...
    public void setUpExamples()
    {
        ...
        getGenericServer().registerExperiment(sessionToken, experiment, Arrays.<NewAttachment>asList());
        ExperimentIdentifier experimentIdentifier = ExperimentIdentifierFactory.parse(EXPERIMENT_IDENTIFIER);
        experimentId = getCommonServer().getExperimentInfo(sessionToken, experimentIdentifier).getId();
