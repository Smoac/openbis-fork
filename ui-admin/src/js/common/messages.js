...
const keys = {
  ...
  VALIDATION_INTERNAL_TERM_CODE_PATTERN: 'VALIDATION_INTERNAL_TERM_CODE_PATTERN',
...
const messages_en = {
  ...
  [keys.GENERATE_CONTROLS]: 'Generate Controls',
  ...
  [keys.VALIDATION_INTERNAL_TERM_CODE_PATTERN]: '${0} has to start with $ and can only contain A-Z, a-z, 0-9 and _, -, ., :',
