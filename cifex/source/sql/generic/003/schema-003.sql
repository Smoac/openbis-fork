...
CREATE TABLE USERS  (ID TECH_ID NOT NULL,USER_ID USER_ID NOT NULL, EMAIL OBJECT_NAME NOT NULL,FULL_NAME OBJECT_NAME,ENCRYPTED_PASSWORD MD5_SUM,IS_EXTERNALLY_AUTHENTICATED BOOLEAN_CHAR DEFAULT 'FALSE',IS_ADMIN BOOLEAN_CHAR NOT NULL DEFAULT 'FALSE',IS_PERMANENT BOOLEAN_CHAR NOT NULL DEFAULT 'FALSE',REGISTRATION_TIMESTAMP TIME_STAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,USER_ID_REGISTRATOR TECH_ID, EXPIRATION_TIMESTAMP TIME_STAMP);
