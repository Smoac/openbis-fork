...
--  3. At the table levle, changed the DEFAULT value from SYSDATE to CURRENT_TIMESTAMP
...
CREATE TABLE FILES  (ID TECH_ID NOT NULL,NAME FILE_NAME NOT NULL,PATH FILE_NAME NOT NULL,REGISTRATION_TIMESTAMP TIME_STAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,EXPIRATION_TIMESTAMP TIME_STAMP NOT NULL,USER_ID TECH_ID NOT NULL) ;
CREATE TABLE USERS  (ID TECH_ID NOT NULL,EMAIL EMAIL NOT NULL,USER_NAME USER_NAME,ENCRYPTED_PASSWORD MD5_SUM,IS_EXTERNALLY_AUTHENTICATED BOOLEAN_CHAR DEFAULT 'FALSE',IS_ADMIN BOOLEAN_CHAR NOT NULL DEFAULT 'FALSE',IS_PERMANENT BOOLEAN_CHAR NOT NULL DEFAULT 'FALSE',REGISTRATION_TIMESTAMP TIME_STAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,EXPIRATION_TIMESTAMP TIME_STAMP) ;
