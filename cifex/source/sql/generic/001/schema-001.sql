...
ALTER TABLE FILES ADD CONSTRAINT FILE_USER_FK FOREIGN KEY (USER_ID_REGISTERER) REFERENCES USERS(ID) ON DELETE SET NULL;
ALTER TABLE FILE_SHARES ADD CONSTRAINT FS_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILES(ID) ON DELETE CASCADE;
ALTER TABLE FILE_SHARES ADD CONSTRAINT FS_USER_FK FOREIGN KEY (USER_ID) REFERENCES USERS(ID) ON DELETE CASCADE;
