...
-------------------------------------------------------------------------------------------
--  Purpose:  Create and set a new quota_group if none is provided when inserting a user
-------------------------------------------------------------------------------------------
...
CREATE TRIGGER UPDATE_QUOTA_GROUP_ID_ON_INSERT_USER BEFORE INSERT ON USERS
