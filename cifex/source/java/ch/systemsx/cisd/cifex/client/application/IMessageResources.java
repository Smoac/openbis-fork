...
public interface IMessageResources extends Messages {
	...
	/**
	 * Returns a default invocation exception message (as it obviously does not
	 * contain any).
	 */
	...
	/**
	 * Returns a default message for exception that does not contain any
	 * message. *
	 * <p>
	...
	public String getFileUploadFeedbackBytesLabel(final String bytesRead,
	...
	/**
	 * Returns the label for the login form that decides whether it is an admin
	 * login.
	 */
	...
	/**
	 * Returns the help text for uploading files section recipients (case
	 * permanent user).
	 */
