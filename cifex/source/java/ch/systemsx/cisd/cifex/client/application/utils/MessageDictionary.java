...
public enum MessageDictionary
{
    ...
    UPLOAD_FILES_WEBSTART_PANEL_TITLE,
    
    UPLOAD_FILES_LAUNCH_WEBSTART_LABEL,
    
    UPLOAD_FILES_WEBSTART_PROS_INFO,
    ...
    DOWNLOAD_FILES_WEBSTART_PANEL_TITLE,
    
    DOWNLOAD_FILES_LAUNCH_WEBSTART_LABEL,
    
    DOWNLOAD_FILES_WEBSTART_PROS_INFO,
