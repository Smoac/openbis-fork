...
final class OwnerFileAsyncCallback extends AbstractAsyncCallback<List<OwnerFileInfoDTO>>
{
    ...
    OwnerFileAsyncCallback(final ViewContext context, final LayoutContainer contentPanel,
    ...
    public final void onSuccess(final List<OwnerFileInfoDTO> files)
    {
        final Widget widget;
    ...
    private Widget createFileGrid(final List<OwnerFileInfoDTO> files,
    ...
    private HTML createNoFilesLabel(IMessageResources messageResources)
    {
        ...
        html.setText(messageResources.getUploadedFilesEmpty());
        return html;
    }
}