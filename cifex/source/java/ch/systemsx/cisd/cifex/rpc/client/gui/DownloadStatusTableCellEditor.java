...
public class DownloadStatusTableCellEditor extends AbstractCellEditor implements TableCellEditor
{
    ...
    final FileDownloadClientModel tableModel;

    FileDownloadInfo selectedFileDownloadInfo;

    DownloadStatusTableCellEditor(FileDownloadClientModel tableModel)
    {
        super();
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected,
            int row, int column)
    {
        selectedFileDownloadInfo = (FileDownloadInfo) value;
        if (isSelected)
        {
