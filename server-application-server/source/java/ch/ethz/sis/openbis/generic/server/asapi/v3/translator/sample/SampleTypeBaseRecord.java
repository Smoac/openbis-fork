 ...
 * @author pkupczyk
 */
public class SampleTypeBaseRecord extends ObjectBaseRecord
{
    ...
    public boolean subcodeUnique;

    public boolean autoGeneratedCode;

    public int generatedFromDepth;

    public int partOfDepth;

    public boolean showParentMetadata;
