...
ALTER TABLE EXPERIMENT_TYPES ADD CONSTRAINT ET_BK_UK UNIQUE(CODE,IS_MANAGED_INTERNALLY);
...
ALTER TABLE MATERIAL_TYPES ADD CONSTRAINT MT_BK_UK UNIQUE(CODE,IS_MANAGED_INTERNALLY);
...
ALTER TABLE SAMPLE_TYPES ADD CONSTRAINT ST_BK_UK UNIQUE(CODE,IS_MANAGED_INTERNALLY);
...
ALTER TABLE DATA_SET_TYPES ADD CONSTRAINT DST_BK_UK UNIQUE(CODE,IS_MANAGED_INTERNALLY);
