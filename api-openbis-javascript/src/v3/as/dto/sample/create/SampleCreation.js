 ...
 * @author pkupczyk
 */
define([ "stjs", "as/dto/common/Relationship", "as/dto/common/entity/AbstractEntityCreation" ], function(stjs, Relationship, AbstractEntityCreation) {
	var SampleCreation = function() {
	    AbstractEntityCreation.call(this);
		this.properties = {};
		this.relationships = {};
	};
	stjs.extend(SampleCreation, AbstractEntityCreation, [AbstractEntityCreation], function(constructor, prototype) {
