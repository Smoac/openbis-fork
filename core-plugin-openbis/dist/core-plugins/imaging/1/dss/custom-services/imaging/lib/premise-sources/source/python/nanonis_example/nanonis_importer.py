...
config_dat_preview = {
    ...
    "grouping": ["didv_00063.dat", "didv_00064.dat", "didv_00065.dat", "didv_00066.dat", "didv_00067.dat", "didv_00068.dat", "didv_00069.dat", "didv_00070.dat"],
    "colormap": "rainbow",
    "scaling": "lin-lin", # ['lin-lin', 'lin-log', 'log-lin', 'log-log']
    # "print_legend": "false", # uncomment this to disable legend in image
    # "mode": 1 # uncomment this if you want to generate random pixel image generation
}

config_preview = config_dat_preview

permId = '20231129145334261-68' # SXM
permId = '20231129160614975-71' # DAT

preview = create_preview(o, permId, config_preview)
preview.save_to_file('/home/alaskowski/PREMISE/my_image.png')

update_image_with_preview(o, permId, 0, preview)
...
export_image(o, permId, 0, '/home/alaskowski/PREMISE')
