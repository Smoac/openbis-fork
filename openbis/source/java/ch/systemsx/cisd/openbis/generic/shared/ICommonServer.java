...
public interface ICommonServer extends IServer
{
    ...
    /**
     * Returns all samples which have at least one property of type MATERIAL referring to one of the
     * specified materials.
     */
    @Transactional(readOnly = true)
    ...
    @DatabaseCreateOrDeleteModification(value =
        { ObjectKind.PROPERTY_TYPE, ObjectKind.PROPERTY_TYPE_ASSIGNMENT, ObjectKind.DATASET_TYPE,
    ...
    @Transactional
    @DatabaseCreateOrDeleteModification(value =
        { ObjectKind.PROPERTY_TYPE, ObjectKind.PROPERTY_TYPE_ASSIGNMENT })
    public String registerAndAssignPropertyType(final String sessionToken,
            PropertyType propertyType, NewETPTAssignment assignment);
    ...
    /**
     * Returns the technical ids of all materials which have at least one property of type MATERIAL
     * referring to one of the specified materials.
     */
    @Transactional(readOnly = true)
