...
public class V3ProjectCreationPredicate extends AbstractPredicate<List<ProjectCreation>>
{

	protected final SpaceCollectionPredicate spaceCollectionPredicate;

    public V3ProjectCreationPredicate()
    {
    ...
    @Override
    protected Status doEvaluation(PersonPE person, List<RoleWithIdentifier> allowedRoles, List<ProjectCreation> value)
    {
