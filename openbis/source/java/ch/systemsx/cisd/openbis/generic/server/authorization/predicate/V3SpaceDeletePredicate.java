...
public class V3SpaceDeletePredicate extends AbstractPredicate<List<ISpaceId>>
{
    ...
    @Override
    protected Status doEvaluation(PersonPE person, List<RoleWithIdentifier> allowedRoles, List<ISpaceId> value)
    {
