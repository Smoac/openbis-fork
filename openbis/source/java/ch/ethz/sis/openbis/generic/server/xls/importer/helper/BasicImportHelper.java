...
public abstract class BasicImportHelper extends AbstractImportHelper
{
    ...
    protected static boolean isNewVersionWithInternalNamespace(Map<String, Integer> header, List<String> values, Map<String, Integer> versions, boolean isSystem, String type, IAttribute versionAttribute, IAttribute codeAttribute, boolean isInternalNamespace)
    {
