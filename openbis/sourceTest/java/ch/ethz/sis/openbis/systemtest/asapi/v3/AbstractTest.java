...
public class AbstractTest extends SystemTestCase
{
    ...
    protected void deletePropertyTypes(final String sessionToken, final IPropertyTypeId... propertyTypeIds)
    {
        ...
        v3api.deletePropertyTypes(sessionToken, Arrays.asList(propertyTypeIds), deletionOptions);
    }
            ...
            PropertyTypePermId... propertyTypes)
    {
        ...
        return v3api.createSampleTypes(sessionToken, Collections.singletonList(creation)).get(0);
    }
    ...
    protected void deleteSampleTypes(final String sessionToken, final IEntityTypeId... entityTypeIds)
    {
        ...
        deletionOptions.setReason("Test");
        v3api.deleteSampleTypes(sessionToken, Arrays.asList(entityTypeIds), deletionOptions);
    }
    ...
    protected void testWithUserRole(RoleWithHierarchy role, TestWithUserRole action)
    {
        ...
        final PersonPermId personId = v3api.createPersons(adminSessionToken, Collections.singletonList(personCreation)).get(0);
        ...
        List<SpacePermId> spaceIds = v3api.createSpaces(adminSessionToken, Arrays.asList(space1Creation, space2Creation));
        ...
        List<ProjectPermId> projectIds = v3api.createProjects(adminSessionToken, Arrays.asList(space1Project1Creation, space1Project2Creation));
        ...
        } else if (role.isSpaceLevel() || role.isProjectLevel())
        {
            ...
            v3api.createRoleAssignments(adminSessionToken, Arrays.asList(roleCreation, roleCreation2));
        }
