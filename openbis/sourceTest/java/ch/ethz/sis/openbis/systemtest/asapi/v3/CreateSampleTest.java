...
public class CreateSampleTest extends AbstractSampleTest
{
    ...
    public void testCreateWithDifferentRolesExperimentSample(RoleWithHierarchy role)
    {
        testWithUserRole(role, params ->
        {
            ...
            final ExperimentPermId experimentId = v3api.createExperiments(params.adminSessionToken, Arrays.asList(experimentCreation)).get(0);
    ...
    public void testCreateWithDifferentRolesParentChildSample(RoleWithHierarchy role)
    {
        testWithUserRole(role, params ->
        {
            ...
            parentCreation.setChildIds(Arrays.asList(childCreation.getCreationId()));
            ...
            if (Arrays.asList(RoleWithHierarchy.RoleLevel.INSTANCE, RoleWithHierarchy.RoleLevel.SPACE).contains(role.getRoleLevel()) && Arrays.asList(
                    ...
                    .contains(role.getRoleCode()))
            {
                v3api.createSamples(params.userSessionToken, Arrays.asList(parentCreation, childCreation));
            } else
            {
