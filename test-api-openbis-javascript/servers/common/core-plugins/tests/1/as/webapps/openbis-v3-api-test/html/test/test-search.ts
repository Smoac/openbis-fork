        ...
        var executeModule = function (moduleName: string, facade: openbis.openbis, dtos: openbis.bundle) {
            ...
            QUnit.test("dataStoreFacade.searchFiles() atMultipleChosenDataStores", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, files: openbis.DataSetFile[]) {
                    ...
                    c.assertObjectsWithValues(files, "path", [
                        "",
                        "feature_lists",
                        "feature_lists/NUMBER_FEATURE_LIST",
                        "original",
                        "original/emptyFile",
                    ])
            ...
            QUnit.test("searchSemanticAnnotations() withPermId", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, annotations: openbis.SemanticAnnotation[]) {
            ...
            QUnit.test("searchSemanticAnnotations() withPredicate and withDescriptor", function (assert) {
                ...
                var fSearch = function (facade: openbis.openbis) {
                    return c
                        .createSemanticAnnotation(facade)
                ...
                var fCheck = function (facade: openbis.openbis, annotations: openbis.SemanticAnnotation[]) {
                    ...
                    c.assertEqual(
                        ...
                        expectedAnnotation.getPredicateOntologyVersion(),
                    ...
                    c.assertEqual(
                        ...
                        expectedAnnotation.getDescriptorOntologyVersion(),
            ...
            QUnit.test("searchSemanticAnnotations() withPropertyAssignmentId", function (assert) {
                    ...
                    criteria
                        ...
                        .thatEquals(
                            new dtos.PropertyAssignmentPermId(
                                new dtos.EntityTypePermId("LIBRARY", "SAMPLE"),
                                new dtos.PropertyTypePermId("PREPARED_BY")
                            )
                        )
                    return facade.searchSemanticAnnotations(criteria, c.createSemanticAnnotationFetchOptions())
                }
                ...
                var fCheck = function (facade: openbis.openbis, annotations: openbis.SemanticAnnotation[]) {
                    ...
                    c.assertEqual(
                        (<openbis.EntityTypePermId>annotations[0].getPropertyAssignment().getEntityType().getPermId()).getEntityKind(),
                        "SAMPLE",
                        "Entity type kind"
                    )
            ...
            QUnit.test("searchPropertyTypes() withPermId", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, types: openbis.PropertyType[]) {
                    c.assertEqual(types.length, 1)
                    c.assertEqual(types[0].getLabel(), "Total reads", "Label")
                }
                ...
                var fSearch = function (facade: openbis.openbis) {
                    ...
                    criteria
                        ...
                        .thatEquals(
                            new dtos.PropertyAssignmentPermId(
                                new dtos.EntityTypePermId("LIBRARY", "SAMPLE"),
                                new dtos.PropertyTypePermId("EXTERNAL_SAMPLE_NAME")
                            )
                        )
                    return facade.searchPropertyAssignments(criteria, c.createPropertyAssignmentFetchOptions())
                }

                var fCheck = function (facade: openbis.openbis, types: openbis.PropertyAssignment[]) {
                    c.assertEqual(types.length, 1)
            ...
            QUnit.test("searchDeletions()", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, deletions: openbis.Deletion[]) {
            ...
            QUnit.test("searchEvents()", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, events: openbis.Event[]) {
            ...
            QUnit.test("searchEvents() withEntityType", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, events: openbis.Event[]) {
                    ...
                    c.assertEqual((<openbis.ProjectPermId>events[1].getEntityProjectId()).getPermId(), "20210514121033383-440", "Entity Project Id")
                    ...
                    c.assertEqual((<openbis.ProjectPermId>events[2].getEntityProjectId()).getPermId(), "20210514121033383-440", "Entity Project Id")
            ...
            QUnit.test("searchEvents() withEntitySpace", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, events: openbis.Event[]) {
                    ...
                    c.assertEqual((<openbis.SpaceTechId>events[0].getEntitySpaceId()).getTechId(), 6, "Entity Space Id")
                    c.assertEqual(events[0].getEntityProject(), "/EVENT_TEST_SPACE_C/EVENT_TEST_PROJECT_C", "Entity Project")
                    c.assertEqual((<openbis.ProjectPermId>events[0].getEntityProjectId()).getPermId(), "20210514121033383-441", "Entity Project Id")
            ...
            QUnit.test("searchEvents() withEntityProject", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, events: openbis.Event[]) {
                    ...
                    c.assertEqual((<openbis.ProjectPermId>events[0].getEntityProjectId()).getPermId(), "20210514121033383-440", "Entity Project Id")
            ...
            QUnit.test("searchQueries() withId", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, queries: openbis.Query[]) {
            ...
            QUnit.test("searchQueryDatabases() withId", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, databases: openbis.QueryDatabase[]) {
            ...
            QUnit.test("searchPersonalAccessTokens() withId", function (assert) {
                ...
                var fCheck = function (facade: openbis.openbis, pats: openbis.PersonalAccessToken[]) {
            ...
            QUnit.test("searchSamples() withProperty", function (assert) {
                ...
                var sampleTypeId
                var fSearch = function (facade: openbis.openbis) {
                    return createPropertyType(c, facade, dtos.DataType.VARCHAR).then(
                        function (propertyTypeIds) {
                            propertyTypeId = propertyTypeIds[0]
                            return createSampleType(c, facade, false).then(function (sampleTypeIds) {
                                sampleTypeId = sampleTypeIds[0]
                                return createSample(c, facade, sampleTypeIds[0], propertyTypeIds[0], "abc").then(function (sampleIds) {
                ...
                var fCleanup = function (facade: openbis.openbis, samples: openbis.Sample[]) {
                    if (samples) {
            ...
            QUnit.test("searchSamples() withNumberProperty", function (assert) {
                ...
                var sampleTypeId
                var fSearch = function (facade: openbis.openbis) {
                    return createPropertyType(c, facade, dtos.DataType.INTEGER).then(
                        function (propertyTypeIds) {
                            propertyTypeId = propertyTypeIds[0]
                            return createSampleType(c, facade, false).then(function (sampleTypeIds) {
                                sampleTypeId = sampleTypeIds[0]
                                return createSample(c, facade, sampleTypeIds[0], propertyTypeIds[0], 12344).then(function (sampleIds) {
                                    samplePermId = sampleIds[0]
                                    var criteria = new dtos.SampleSearchCriteria()
            ...
            QUnit.test("searchSamples() withBooleanProperty", function (assert) {
                ...
                var fSearch = function (facade: openbis.openbis) {
                    return createPropertyType(c, facade, dtos.DataType.BOOLEAN).then(function (propertyTypeIds) {
                        ...
                        return createSampleType(c, facade, false).then(function (sampleTypeIds) {
                            sampleTypeId = sampleTypeIds[0]
                            return createSample(c, facade, sampleTypeIds[0], propertyTypeIds[0], true).then(function (sampleIds) {
                                samplePermId = sampleIds[0]
                                var criteria = new dtos.SampleSearchCriteria()
            ...
            QUnit.test("searchSamples() withDateProperty", function (assert) {
                ...
                var sampleTypeId
                var fSearch = function (facade: openbis.openbis) {
                    return createPropertyType(c, facade, dtos.DataType.DATE).then(
                        function (propertyTypeIds) {
                            propertyTypeId = propertyTypeIds[0]
                            return createSampleType(c, facade, false).then(function (sampleTypeIds) {
                                sampleTypeId = sampleTypeIds[0]
                                return createSample(c, facade, sampleTypeIds[0], propertyTypeIds[0], "2007-07-17").then(function (sampleIds) {
                                    samplePermId = sampleIds[0]
                                    var criteria = new dtos.SampleSearchCriteria()
                ...
                var fSearch = function (facade: openbis.openbis) {
                    return createPropertyType(c, facade, dtos.DataType.DATE).then(
                        function (propertyTypeIds) {
                            ...
                            return createSampleType(c, facade, false).then(function (sampleTypeIds) {
                                sampleTypeId = sampleTypeIds[0]
                                return createSample(c, facade, sampleTypeIds[0], propertyTypeIds[0], "2017-09-17").then(function (sampleIds) {
                                    samplePermId = sampleIds[0]
                                    var criteria = new dtos.SampleSearchCriteria()
