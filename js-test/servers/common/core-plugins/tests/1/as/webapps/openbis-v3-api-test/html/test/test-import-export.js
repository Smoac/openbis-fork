 ...
 */
  ...
  require(["jquery", "underscore", "openbis", "test/common", "test/openbis-execute-operations", "test/dtos"], function($, _, openbisRequireJS, common, openbisExecuteOperations, dtos) {
