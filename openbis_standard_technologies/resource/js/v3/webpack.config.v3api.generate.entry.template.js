...
dtos
  ...
  .forEach(dto => {
    console.log('import ' + dto.pathWithUnderscores + " from '../../../../../openbis/source/java/ch/systemsx/cisd/openbis/public/resources/api/v3/" + dto.pathWithSlashes + "'")
  })

console.log("import stjs from '../../../../../openbis/source/java/ch/systemsx/cisd/openbis/public/resources/api/v3/lib/stjs/js/stjs'")
console.log("import underscore from '../../../../../openbis/source/java/ch/systemsx/cisd/openbis/public/resources/api/v3/lib/underscore/js/underscore'")
console.log("import openbis from '../../../../../openbis/source/java/ch/systemsx/cisd/openbis/public/resources/api/v3/openbis'")
